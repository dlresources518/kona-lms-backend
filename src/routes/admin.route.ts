...
class AdminRouter {
  ...
  private initializeRoutes(): void {
    ...
    this.router.get('/allRegisteredUsers', verifyToken, this.adminController.allRegisteredUsers);
    ...
    this.router.post('/updateCoursesToStudent',this.adminController.updateCoursesToStudent);
  }
}
